...
path_to_folder = "F:/matlab_conn/project/conn_project_rabies_all_rois_smoothed_0.5" # 2.Change folder directory to your conn project folder
...
np.save('corrs_r_rabies_all_0.5.npy', corrs_r)
np.save('corrs_r2_rabies_all_0.5.npy', corrs_r2)
...
path_to_folder = "F:/matlab_conn/project/conn_project_rabies_all_rois_smoothed_0.5_gsr" # 2.Change folder directory to your conn project folder
...
np.save('corrs_r_rabies_all_0.5_gsr.npy', corrs_r)
np.save('corrs_r2_rabies_all_0.5_gsr.npy', corrs_r2)
