...
corrs_r_rabies_0_5_gsr = np.load('corrs_r_rabies_all_0.5.npy')
...
data_x = [corrs_r_matlab_all_gsr, corrs_r_mdma_all_gsr, corrs_r_rabies_0_5_gsr, corrs_r_marciano_gsr]
data_y = [corrs_r2_matlab_all_gsr, corrs_r2_mdma_all_gsr, corrs_r2_rabies_0_5_gsr,  corrs_r2_marciano_gsr]
kdes_x = []
kdes_y = []
...
labels = ['Haas GSR', 'Ionescu GSR', 'Haas Rabies GSR', 'Marciano GSR']
...
ax2.set_xlim([-0.3, 1])
ax2.set_ylim([-0.7, 1])
ax2.legend(fontsize = 8, loc = 'upper left', markerscale = 0.75, frameon = False, title = 'Dataset', title_fontsize = 9, labelspacing = 0.2, handlelength = 0, borderaxespad = 2, draggable = True, )
...
plt.savefig('D:/Uni/Master/Masterarbeit/figures/thesis figures/qc corrs only GSR comp.png', dpi = 400, bbox_inches='tight')
