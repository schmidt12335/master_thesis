...
path_to_folder = "F:/matlab_conn/project/conn_project_rabies_all_rois_short" # 2.Change folder directory to your conn project folder
...
path_to_folder = "F:/matlab_conn/project/conn_project_rabies_all_rois_short_gsr" # 2.Change folder directory to your conn project folder
...
np.save('corrs_r_rabies_gsr.npy', corrs_r)
np.save('corrs_r2_rabies_gsr.npy', corrs_r2)
