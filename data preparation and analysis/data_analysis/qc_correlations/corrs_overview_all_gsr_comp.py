...
#data_x = [corrs_r_matlab_all, corrs_r_matlab_all_gsr, corrs_r_mdma_all,corrs_r_mdma_all_gsr, corrs_r_rabies_0_5, corrs_r_rabies_0_5_gsr, corrs_r_marciano, corrs_r_marciano_gsr]
#data_y = [corrs_r2_matlab_all, corrs_r2_matlab_all_gsr, corrs_r2_mdma_all, corrs_r2_mdma_all_gsr, corrs_r2_rabies_0_5,  corrs_r2_rabies_0_5_gsr, corrs_r2_marciano,  corrs_r2_marciano_gsr]

data_x = [corrs_r_matlab_all, corrs_r_rabies_0_5, corrs_r_mdma_all, corrs_r_marciano, corrs_r_matlab_all_gsr, corrs_r_rabies_0_5_gsr, corrs_r_mdma_all_gsr, corrs_r_marciano_gsr]
data_y = [corrs_r2_matlab_all, corrs_r2_rabies_0_5, corrs_r2_mdma_all, corrs_r2_marciano, corrs_r2_matlab_all_gsr, corrs_r2_rabies_0_5_gsr, corrs_r2_mdma_all_gsr, corrs_r2_marciano_gsr]
...
for i in range(len(data_x)):
    if i < 4:
        ax2.plot(data_x[i], data_y[i], linestyle='', marker='o', label=labels[i], markersize = 4, alpha = 0.15)  # , c = cmap[0])
    else:
