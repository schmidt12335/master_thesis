...
corrs_r_rabies_0_5 = np.load('corrs_r_rabies_all_0.5_new.npy')
corrs_r2_rabies_0_5 = np.load('corrs_r2_rabies_all_0.5_new.npy')

corrs_r_rabies_0_5_gsr = np.load('corrs_r_rabies_all_0.5_gsr_new.npy')
corrs_r2_rabies_0_5_gsr = np.load('corrs_r2_rabies_all_0.5_gsr_new.npy')

data_x_kde = [corrs_r_matlab_all, corrs_r_matlab_all_gsr, corrs_r_rabies_0_5, corrs_r_rabies_0_5_gsr]
data_y_kde = [corrs_r2_matlab_all, corrs_r2_matlab_all_gsr, corrs_r2_rabies_0_5, corrs_r2_rabies_0_5_gsr]
kdes_x = []
kdes_y = []
...
data_x = [corrs_r_matlab_all, corrs_r_matlab_all_gsr, corrs_r_rabies_0_5, corrs_r_rabies_0_5_gsr]
data_y = [corrs_r2_matlab_all, corrs_r2_matlab_all_gsr, corrs_r2_rabies_0_5, corrs_r2_rabies_0_5_gsr]

x_labels = [f'AC MATLAB',f'AC MATLAB GSR', f'AC RABIES', f'AC RABIES GSR']
