...
path_to_folder = "F:/matlab_conn/project/conn_project_schifer_all_rois" # 2.Change folder directory to your conn project folder
...
path_to_folder = "F:/matlab_conn/project/conn_project_schifer_all_rois_gsr" # 2.Change folder directory to your conn project folder
