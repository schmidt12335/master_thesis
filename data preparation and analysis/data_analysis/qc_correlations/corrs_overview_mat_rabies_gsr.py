...
labels = [f'AC MATLAB', f'AC MATLAB GSR', f'AC RABIES', f'AC RABIES GSR']
...
plt.savefig('D:/Uni/Master/Masterarbeit/figures/thesis figures/qc corrs matlab rabies haas GSR.png', dpi = 400, bbox_inches='tight')
